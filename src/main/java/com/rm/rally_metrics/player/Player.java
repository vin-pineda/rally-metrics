...
public class Player {
    ...
    public Double getGamesWonPercent() {
        return gamesWonPercent;
    }

    public void setGamesWonPercent(Double gamesWonPercent) {
        this.gamesWonPercent = gamesWonPercent;
    }

    public Integer getPtsWon() {
        return ptsWon;
    }

    public void setPtsWon(Integer ptsWon) {
        this.ptsWon = ptsWon;
    }

    public Integer getPtsLost() {
        return ptsLost;
    }

    public void setPtsLost(Integer ptsLost) {
        this.ptsLost = ptsLost;
    }

    public Double getPtsWonPercent() {
        return ptsWonPercent;
    }

    public void setPtsWonPercent(Double ptsWonPercent) {
        this.ptsWonPercent = ptsWonPercent;
    }
}
