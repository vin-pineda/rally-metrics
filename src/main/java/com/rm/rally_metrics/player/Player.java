...
public class Player {
    ...
    public Player(String name, Integer rank, String team, Integer gamesWon, Integer gamesLost, Double gamesWonPercent, Integer ptsWon, Integer ptsLost, Double ptsWonPercent) {
        this.name = name;
        this.rank = rank;
        this.team = team;
