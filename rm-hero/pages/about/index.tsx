...
export default function AboutPage() {
  ...
  return (
    <DefaultLayout>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-10 sm:pt-16 pb-20 sm:pb-32">
        <motion.div
        ...
        >
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-amber-500 to-orange-600"
            transition={{
              duration: 6,
              repeat: Infinity,
              ease: "linear",
